...
@InputType()
export class DeviceUncheckedUpdateManyWithoutSpbuNestedInput {
    ...
    @Field(() => [DeviceUpsertWithWhereUniqueWithoutSpbuInput], {nullable:true})
    ...
    @Field(() => [DeviceUpdateWithWhereUniqueWithoutSpbuInput], {nullable:true})
