...
@InputType()
export class HistoryPengisianUpdateManyWithoutUserNestedInput {
    ...
    @Field(() => [HistoryPengisianUpsertWithWhereUniqueWithoutUserInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateWithWhereUniqueWithoutUserInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateManyWithWhereWithoutUserInput], {nullable:true})
