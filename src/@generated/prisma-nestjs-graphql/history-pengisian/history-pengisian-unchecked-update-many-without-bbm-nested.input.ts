...
@InputType()
export class HistoryPengisianUncheckedUpdateManyWithoutBbmNestedInput {
  ...
  @Field(() => [HistoryPengisianUpdateWithWhereUniqueWithoutBbmInput], {
    nullable: true,
  })
  ...
  @Field(() => [HistoryPengisianUpdateManyWithWhereWithoutBbmInput], {
    nullable: true,
  })
