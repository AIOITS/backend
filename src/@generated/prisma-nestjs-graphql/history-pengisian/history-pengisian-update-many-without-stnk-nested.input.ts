...
@InputType()
export class HistoryPengisianUpdateManyWithoutStnkNestedInput {
    ...
    @Field(() => [HistoryPengisianCreateOrConnectWithoutStnkInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpsertWithWhereUniqueWithoutStnkInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateWithWhereUniqueWithoutStnkInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateManyWithWhereWithoutStnkInput], {nullable:true})
