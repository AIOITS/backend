...
export class HistoryPengisianUpdateInput {
    ...
    @Field(() => DeviceUpdateOneRequiredWithoutHistoryPengisianNestedInput, {nullable:true})
    device?: DeviceUpdateOneRequiredWithoutHistoryPengisianNestedInput;

    @Field(() => SpbuUpdateOneRequiredWithoutHistoryPengisianNestedInput, {nullable:true})
    spbu?: SpbuUpdateOneRequiredWithoutHistoryPengisianNestedInput;

    @Field(() => BbmUpdateOneWithoutHistoryPengisianNestedInput, {nullable:true})
    bbm?: BbmUpdateOneWithoutHistoryPengisianNestedInput;

    @Field(() => UserUpdateOneWithoutHistory_pengisianNestedInput, {nullable:true})
    user?: UserUpdateOneWithoutHistory_pengisianNestedInput;

    @Field(() => StnkUpdateOneRequiredWithoutHistory_pengisianNestedInput, {nullable:true})
