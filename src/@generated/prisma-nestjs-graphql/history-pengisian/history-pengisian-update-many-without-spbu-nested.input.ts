...
@InputType()
export class HistoryPengisianUpdateManyWithoutSpbuNestedInput {
    ...
    @Field(() => [HistoryPengisianUpsertWithWhereUniqueWithoutSpbuInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateWithWhereUniqueWithoutSpbuInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateManyWithWhereWithoutSpbuInput], {nullable:true})
