...
@InputType()
export class HistoryPengisianUpdateManyWithoutDeviceNestedInput {
    ...
    @Field(() => [HistoryPengisianUpsertWithWhereUniqueWithoutDeviceInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateWithWhereUniqueWithoutDeviceInput], {nullable:true})
    ...
    @Field(() => [HistoryPengisianUpdateManyWithWhereWithoutDeviceInput], {nullable:true})
