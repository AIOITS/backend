...
@InputType()
export class StnkUncheckedUpdateManyWithoutKtpNestedInput {
    ...
    set?: Array<Prisma.AtLeast<StnkWhereUniqueInput, 'nomor_stnk' | 'nomor_polisi' | 'nomor_pkb'>>;

    @Field(() => [StnkWhereUniqueInput], {nullable:true})
    @Type(() => StnkWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<StnkWhereUniqueInput, 'nomor_stnk' | 'nomor_polisi' | 'nomor_pkb'>>;

    @Field(() => [StnkWhereUniqueInput], {nullable:true})
    @Type(() => StnkWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<StnkWhereUniqueInput, 'nomor_stnk' | 'nomor_polisi' | 'nomor_pkb'>>;

    @Field(() => [StnkWhereUniqueInput], {nullable:true})
    @Type(() => StnkWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<StnkWhereUniqueInput, 'nomor_stnk' | 'nomor_polisi' | 'nomor_pkb'>>;
