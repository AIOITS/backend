...
import { StnkUpdateManyWithoutKtpNestedInput } from '../stnk/stnk-update-many-without-ktp-nested.input';

@InputType()
export class KtpUpdateWithoutUserInput {
    ...
    @Field(() => EnumStatusPerkawinanFieldUpdateOperationsInput, {nullable:true})
    ...
    @Field(() => StnkUpdateManyWithoutKtpNestedInput, {nullable:true})
    stnk?: StnkUpdateManyWithoutKtpNestedInput;
}
