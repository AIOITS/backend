...
import { NestedEnumGolonganDarahWithAggregatesFilter } from './nested-enum-golongan-darah-with-aggregates-filter.input'
import { NestedIntFilter } from './nested-int-filter.input'
import { NestedEnumGolonganDarahFilter } from './nested-enum-golongan-darah-filter.input'

@InputType()
export class EnumGolonganDarahWithAggregatesFilter {
