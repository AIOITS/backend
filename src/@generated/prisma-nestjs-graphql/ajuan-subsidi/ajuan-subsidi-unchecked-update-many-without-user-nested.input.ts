...
@InputType()
export class AjuanSubsidiUncheckedUpdateManyWithoutUserNestedInput {
  ...
  @Field(() => [AjuanSubsidiUpsertWithWhereUniqueWithoutUserInput], {
    nullable: true,
  })
